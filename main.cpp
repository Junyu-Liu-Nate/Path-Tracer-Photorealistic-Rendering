...
int main(int argc, char *argv[])
{
    ...
    tracer.settings = {
        ...
        // Below are flags for extra credit
        .enableDepthOfField =  settings.value("Settings/enableDepthOfField").toBool(),
        .enableStratifiedSampling =  settings.value("Settings/enableStratifiedSampling").toBool(),
        .enableLowDiscrepancySampling =  settings.value("Settings/enableLowDiscrepancySampling").toBool(),
        .enableAttenuateRefraction =  settings.value("Settings/enableAttenuateRefraction").toBool(),
        .enableImportanceSampling =  settings.value("Settings/enableImportanceSampling").toBool(),
        .enableWardAnisotropicBRDF =  settings.value("Settings/enableWardAnisotropicBRDF").toBool(),
        .enableCookTorranceBRDF =  settings.value("Settings/enableCookTorranceBRDF").toBool()
    };

    // parse the output image filename to save as pfm
    QFileInfo fileInfo(outputImagePath);
    QString fileNameWithExtension = fileInfo.fileName();
    QString baseName = fileInfo.baseName();
    std::string baseNameStd = baseName.toStdString();
    tracer.pfmFilename = baseNameStd;
